...
/////////////////////// Loader /////////////////////
    ...
    $('#teamwork').LineProgressbar({
        percentage: 95,
    });
    $('#problem_solving').LineProgressbar({
        percentage: 50,
        fillBackgroundColor: '#DA4453'
    });
    $('#web_dev').LineProgressbar({
        percentage: 90,
        fillBackgroundColor: '#E0C341'
    });
    $('#communication').LineProgressbar({
        percentage: 60,
        fillBackgroundColor: '#0F9B8E'
    });
    $('#design').LineProgressbar({
        percentage: 40,
        fillBackgroundColor: '#E17701'
    });
